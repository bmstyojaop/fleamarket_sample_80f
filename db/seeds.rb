...
hobby_etcetra = hobby.children.create(name: "その他")
...
beauty_etcetra = beauty.children.create(name: "その他")
...
election_etcetra = election.children.create(name: "その他")
...
sport_etcetera = sport.children.create(name: "その他")
...
handmade_etcetra = handmade.children.create(name: "その他")
...
hobby_etcetra.children.create([{name: "トランプ/UNO"}, {name: "カルタ/百人一首"}, {name: "ダーツ"}, {name: "ビリヤード"}, {name: "麻雀"}, {name: "パズル/ジグソーパズル"}, {name: "囲碁/将棋"}, {name: "オセロ/チェス"}, {name: "人生ゲーム"}, {name: "野球/サッカーゲーム"}, {name: "スポーツ"}, {name: "三輪車/乗り物"}, {name: "ヨーヨー"}, {name: "模型製作用品"}, {name: "鉄道"}, {name: "航空機"}, {name: "アマチュア無線"}, {name: "パチンコ/パチスロ"}, {name: "その他"}])
...
beauty_etcetra.children.create([{name: "健康用品"}, {name: "看護/介護用品"}, {name: "救急/衛生用品"}, {name: "その他"}])
...
sport_etcetera = sport.children.create([{name: ""}, {name: "その他"}])
