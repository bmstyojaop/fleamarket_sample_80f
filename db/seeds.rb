...
interior_etc.children.create([{name: "その他"}])
...
election_etc.children.create([{name: "その他"}])


sport_golf.children.create([{name: "クラブ"}, {name: "ウェア(男性用)"}, {name: "ウェア(女性用)"}, {name: "バッグ"}, {name: "シューズ(男性用)"}, {name: "シューズ女性用"}, {name: "アクセサリー"}, {name: "その他"}])
sport_fishing.children.create([{name: "ロッド"}, {name: "リール"}, {name: "ルアー用品"}, {name: "ウェア"}, {name: "釣り糸/ライン"}, {name: "その他"}])
sport_bike.children.create([{name: "自転車本体"}, {name: "ウェア"}, {name: "パーツ"}, {name: "アクセサリー"}, {name: "バッグ"}, {name: "工具/メンテナンス"}, {name: "その他"}])
sport_training.children.create([{name: "ランニング"}, {name: "ウォーキング"}, {name: "ヨガ"}, {name: "トレーニング用品"}, {name: "その他"}])
sport_baseball.children.create([{name: "ウェア"}, {name: "シューズ"}, {name: "グローブ"}, {name: "バッド"}, {name: "アクセサリー"}, {name: "防具"}, {name: "練習器具"}, {name: "記念グッズ"}, {name: "応援グッズ"}, {name: "その他"}])
sport_sucker.children.create([{name: "ウェア"}, {name: "シューズ"}, {name: "ボール"}, {name: "アクセサリー"}, {name: "記念グッズ"}, {name: "応援グッズ"}, {name: "その他"}])
...
sport_snowboard.children.create([{name: "ボード"}, {name: "バインエディング"}, {name: "ブーツ(男性用)"}, {name: "ブーツ(女性用)"}, {name: "ブーツ(子ども用)"}, {name: "ウェア/装備(男性用)"}, {name: "ウェア/装備(女性用)"}, {name: "ウェア/装備(子ども用)"}, {name: "アクセサリー"}, {name: "バッグ"}, {name: "その他"}])
sport_ski.children.create([{name: "板"}, {name: "ブーツ(男性用)"}, {name: "ブーツ(女性用)"}, {name: "ブーツ(子ども用)"}, {name: "ビンディング"}, {name: "ウェア(男性用)"}, {name: "ウェア(女性用)"}, {name: "ウェア(子ども用)"}, {name: "ストック"}, {name: "その他"}])
sport_etcSports.children.create([{name: "ダンス/バレエ"}, {name: "サーフィン"}, {name: "バスケットボール"}, {name: "バドミントン"}, {name: "バレーボール"}, {name: "スケートボード"}, {name: "陸上競技"}, {name: "ラグビー"}, {name: "アメリカンフットボール"}, {name: "ボクシング"}, {name: "ボウリング"}, {name: "その他"}])
...
sport_etc.children.create([{name: "その他"}])
