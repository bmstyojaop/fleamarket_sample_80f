...
hobby_instrument = hobby.children.create(name: "音楽/器材")
hobby_correction = hobby.children.create(name: "コレクション")
hobby_military = hobby.children.create(name: "ミリタリー")
hobby_art = hobby.children.create(name: "美術品")
hobby_artItem = hobby.children.create(name: "アート用品")
hobby_etc = hobby.children.create(name: "その他")

beauty_foundation = beauty.children.create(name: "ベースメイク")
...
beauty_etc = beauty.children.create(name: "その他")

election_mobilePhone = election.children.create(name: "スマートフォン/携帯電話")
election_smartphoneAccessory= election.children.create(name: "スマホアクセサリー")
election_pc = election.children.create(name: "PC/タブレット")
election_camera = election.children.create(name: "カメラ")
election_tv = election.children.create(name: "テレビ/映像機器")
election_audio = election.children.create(name: "オーディオ機器")
election_beauty = election.children.create(name: "美容/健康")
election_airConditioning = election.children.create(name: "冷暖房/空調")
election_domestic = election.children.create(name: "生活家電")
election_etc = election.children.create(name: "その他")
...
sport_sucker = sport.children.create(name: "サッカー/フットサル")
...
sport_etcSports = sport.children.create(name: "その他スポーツ")
...
handmade_smallAccessory = handmade.children.create(name: "ファッション/小物")
...
handmade_derivative = handmade.children.create(name: "二次創作")
...
car_bikeAccessory = car.children.create(name: "オートバイアクセサリー")

etcetera_bundle = etcetera.children.create(name: "まとめ売り")
etcetera_pet = etcetera.children.create(name: "ペット用品")
etcetera_food = etcetera.children.create(name: "食品")
etcetera_drink = etcetera.children.create(name: "飲料/酒")
etcetera_commodity = etcetera.children.create(name: "日用品/生活雑貨/旅行")
etcetera_antique = etcetera.children.create(name: "アンティーク/コレクション")
etcetera_stationery = etcetera.children.create(name: "文房具/事務用品")
etcetera_office = etcetera.children.create(name: "事務/店舗用品")
etcetera_etc = etcetera.children.create(name: "その他")
...
kids_etc.children.create([{name: "母子手帳"}, {name: "その他"}])
...
hobby_card.children.create([{name: "遊戯王"}, {name: "マジック：ザ・ギャザリング"}, {name: "ポケモンカードゲーム"}, {name: "デュエルマスターズ"}, {name: "バトルスピリッツ"}, {name: "プリパラ"}, {name: "アイカツ"}, {name: "カードファイト!!ヴァンガード"}, {name: "ヴァイスシュバルツ"}, {name: "プロ野球オーナーズリーグ"}, {name: "ベースボールヒーローズ"}, {name: "ドラゴンボール"}, {name: "スリープ"}, {name: "その他"}])
...
hobby_instrument.children.create([{name: "エレキギター"}, {name: "アコースティックギター"}, {name: "ベース"}, {name: "エフェクター"}, {name: "アンプ"}, {name: "弦楽器"}, {name: "管楽器"}, {name: "鍵盤楽器"}, {name: "打楽器"}, {name: "和楽器"}, {name: "楽譜/スコア"}, {name: "レコーディング/PA器材"}, {name: "DJ器材"}, {name: "DTM/DAW"}, {name: "その他"}])
hobby_correction.children.create([{name: "武具"}, {name: "使用済み切手/官製はがき"}, {name:"旧貨幣/金貨/銀貨/記念硬貨"}, {name: "印刷物"}, {name: "ノベルティグッズ"}, {name: "その他"}])
...
hobby_artItem.children.create([{name: "画材"}, {name: "額縁"}, {name: "その他"}])
hobby_etc.children.create([{name: "トランプ/UNO"}, {name: "カルタ/百人一首"}, {name: "ダーツ"}, {name: "ビリヤード"}, {name: "麻雀"}, {name: "パズル/ジグソーパズル"}, {name: "囲碁/将棋"}, {name: "オセロ/チェス"}, {name: "人生ゲーム"}, {name: "野球/サッカーゲーム"}, {name: "スポーツ"}, {name: "三輪車/乗り物"}, {name: "ヨーヨー"}, {name: "模型製作用品"}, {name: "鉄道"}, {name: "航空機"}, {name: "アマチュア無線"}, {name: "パチンコ/パチスロ"}, {name: "その他"}])

beauty_foundation.children.create([{name: "ファンデーション"}, {name: "化粧下地"}, {name: "コントロールカラー"}, {name: "BBクリーム"}, {name: "CCクリーム"}, {name: "コンシーラー"}, {name: "フェイスパウダー"}, {name: "トライアルセット/サンプル"}, {name: "その他"}])
...
beauty_perfume.children.create([{name: "香水(女性用)"}, {name: "香水(男性用)"}, {name: "ユニセックス"}, {name: "ボディーミスト"}, {name: "その他"}])
...
beauty_body.children.create([{name: "オイルクリーム"}, {name: "ハンドクリーム"}, {name: "ローション"}, {name: "日焼け止め/サンオイル"}, {name: "ボディソープ"}, {name: "入浴剤"}, {name: "制汗/デオドラント"}, {name: "フットケア"}, {name: "その他"}])
...
beauty_diet.children.create([{name: "ダイエット商品"}, {name: "エクササイズ用品"}, {name: "体重計"}, {name: "体脂肪計"}, {name: "その他"}])
beauty_etc.children.create([{name: "健康用品"}, {name: "看護/介護用品"}, {name: "救急/衛生用品"}, {name: "その他"}])

election_mobilePhone.children.create([{name: "スマートフォン本体"}, {name: "バッテリー/充電器"}, {name: "携帯電話本体"}, {name: "PHS本体"}, {name: "その他"}])
election_smartphoneAccessory.children.create([{name: "Android用ケース"}, {name: "iPhone用ケース"}, {name: "カバー"}, {name: "イヤホンジャック"}, {name: "ストラップ"}, {name: "フィルム"}, {name: "自撮り棒"}, {name: "その他"}])
election_pc.children.create([{name: "タブレット"}, {name: "ノートPC"}, {name: "デスクトップ型PC"}, {name: "ディスプレイ"}, {name: "電子ブックリーダー"}, {name: "PC周辺機器"}, {name: "PCパーツ"}, {name: "その他"}])
election_camera.children.create([{name: "デジタルカメラ"}, {name: "ビデオカメラ"}, {name: "レンズ(単焦点)"}, {name: "レンズ(ズーム)"}, {name: "フィルムカメラ"}, {name: "防犯カメラ"}, {name: "その他"}])
election_tv.children.create([{name: "テレビ"}, {name: "プロジェクター"}, {name: "ブルーレイレコーダー"}, {name: "DVDレコーダー"}, {name: "ブルーレイプレーヤー"}, {name: "DVDプレーヤー"}, {name: "映像用ケーブル"}, {name: "その他"}])
election_audio.children.create([{name: "ポータブルプレーヤー"}, {name: "イヤフォン"}, {name: "ヘッドフォン"}, {name: "アンプ"}, {name: "スピーカー"}, {name: "ケーブル/シールド"}, {name: "ラジオ"}, {name: "その他"}])
election_beauty.children.create([{name: "ヘアドライヤー"}, {name: "ヘアアイロン"}, {name: "美容機器"}, {name: "電気シェーバー"}, {name: "電動歯ブラシ"}, {name: "その他"}])
election_airConditioning.children.create([{name: "エアコン"}, {name: "空気清浄機"}, {name: "加湿器"}, {name: "扇風機"}, {name: "除湿機"}, {name: "ファンヒーター"}, {name: "電気ヒーター"}, {name: "オイルヒーター"}, {name: "ストーブ"}, {name: "ホットカーペット"}, {name: "こたつ"}, {name: "電気毛布"}, {name: "その他"}])
election_domestic.children.create([{name: "冷蔵庫"}, {name: "洗濯機"}, {name: "炊飯器"}, {name: "電子レンジ/オーブン"}, {name: "調理機器"}, {name: "アイロン"}, {name: "掃除機"}, {name: "エスプレッソマシン"}, {name: "コーヒーメーカー"}, {name: "衣類乾燥機"}, {name: "その他"}])

sport_golf = sport.children.create([{name: "クラブ"}, {name: "ウェア(男性用)"}, {name: "ウェア(女性用)"}, {name: "バッグ"}, {name: "シューズ(男性用)"}, {name: "シューズ女性用"}, {name: "アクセサリー"}, {name: "その他"}])
sport_fishing = sport.children.create([{name: "ロッド"}, {name: "リール"}, {name: "ルアー用品"}, {name: "ウェア"}, {name: "釣り糸/ライン"}, {name: "その他"}])
sport_bike = sport.children.create([{name: "自転車本体"}, {name: "ウェア"}, {name: "パーツ"}, {name: "アクセサリー"}, {name: "バッグ"}, {name: "工具/メンテナンス"}, {name: "その他"}])
sport_training = sport.children.create([{name: "ランニング"}, {name: "ウォーキング"}, {name: "ヨガ"}, {name: "トレーニング用品"}, {name: "その他"}])
sport_baseball = sport.children.create([{name: "ウェア"}, {name: "シューズ"}, {name: "グローブ"}, {name: "バッド"}, {name: "アクセサリー"}, {name: "防具"}, {name: "練習器具"}, {name: "記念グッズ"}, {name: "応援グッズ"}, {name: "その他"}])
sport_sucker = sport.children.create([{name: "ウェア"}, {name: "シューズ"}, {name: "ボール"}, {name: "アクセサリー"}, {name: "記念グッズ"}, {name: "応援グッズ"}, {name: "その他"}])
sport_tennis = sport.children.create([{name: "ラケット(硬式用)"}, {name: "ラケット(軟式用)"}, {name: "ウェア"}, {name: "シューズ"}, {name: "ボール"}, {name: "アクセサリー"}, {name: "記念グッズ"}, {name: "応援グッズ"}, {name: "その他"}])
sport_snowboard = sport.children.create([{name: "ボード"}, {name: "バインエディング"}, {name: "ブーツ(男性用)"}, {name: "ブーツ(女性用)"}, {name: "ブーツ(子ども用)"}, {name: "ウェア/装備(男性用)"}, {name: "ウェア/装備(女性用)"}, {name: "ウェア/装備(子ども用)"}, {name: "アクセサリー"}, {name: "バッグ"}, {name: "その他"}])
sport_ski = sport.children.create([{name: "板"}, {name: "ブーツ(男性用)"}, {name: "ブーツ(女性用)"}, {name: "ブーツ(子ども用)"}, {name: "ビンディング"}, {name: "ウェア(男性用)"}, {name: "ウェア(女性用)"}, {name: "ウェア(子ども用)"}, {name: "ストック"}, {name: "その他"}])
sport_etcSports = sport.children.create([{name: "ダンス/バレエ"}, {name: "サーフィン"}, {name: "バスケットボール"}, {name: "バドミントン"}, {name: "バレーボール"}, {name: "スケートボード"}, {name: "陸上競技"}, {name: "ラグビー"}, {name: "アメリカンフットボール"}, {name: "ボクシング"}, {name: "ボウリング"}, {name: "その他"}])
sport_outdoor = sport.children.create([{name: "テント/タープ"}, {name: "ライト/ランタン"}, {name: "寝袋/寝具"}, {name: "テーブル/チェア"}, {name: "ストーブ/コンロ"}, {name: "調理器具"}, {name: "食器"}, {name: "登山用品"}, {name: "その他"}])
sport_etc = sport.children.create([{name: ""}, {name: "その他"}])
...
handmade_smallAccessory.children.create([{name: "バッグ(女性用)"}, {name: "バッグ(男性用)"}, {name: "財布(女性用)"}, {name: "財布(男性用)"}, {name: "ファッション雑誌"}, {name: "その他"}])
handmade_clock.children.create([{name: "アクセサリー(男性用)"}, {name: "時計(女性用)"}, {name: "時計(男性用)"}, {name: "その他"}])
handmade_interior.children.create([{name: "キッチン用品"}, {name: "家具"}, {name: "文房具"}, {name: "アート写真"}, {name: "アロマ/キャンドル"}, {name: "フラワー/ガーデン"}, {name: "その他"}])
...
handmade_derivative.children.create([{name: "Ingress"}, {name: "クリエイターズ宇宙兄弟"}])
...
car_parts.children.create([{name: "サスペンション"}, {name: "ブレーキ"}, {name: "外装、エアロパーツ"}, {name: "ライト"}, {name: "内装品、シート"}, {name: "ステアリング"}, {name: "マフラー・排気系"}, {name: "エンジン、過給機、冷却装置"}, {name: "クラッチ、ミッション、駆動系"}, {name: "電装品"}, {name: "補強パーツ"}, {name: "汎用パーツ"}, {name: "外国自動車パーツ"}, {name: "その他"}])
...
car_bikeAccessory.children.create([{name: "ヘルメット/シールド"}, {name: "バイクウエア/装備"}, {name: "アクセサリー"}, {name: "メンテナンス"}, {name: "カタログ/マニュアル"}, {name: "その他"}])

etcetera_pet.children.create([{name: "ペットフード"}, {name: "犬用品"}, {name: "猫用品"}, {name: "魚用品/水草"}, {name: "小動物用品"}, {name: "爬虫類/両生類用品"}, {name: "かご/おり"}, {name: "鳥用品"}, {name: "虫類用品"}, {name: "その他"}])
etcetera_food.children.create([{name: "菓子"}, {name: "米"}, {name: "野菜"}, {name: "果物"}, {name: "調味料"}, {name: "魚介類(加工食品)"}, {name: "肉類(加工食品)"}, {name: "その他 加工食品"}, {name: "その他"}])
etcetera_drink.children.create([{name: "コーヒー"}, {name: "ソフトドリンク"}, {name: "ミネラルウォーター"}, {name: "茶"}, {name: "ウイスキー"}, {name: "ワイン"}, {name: "ブランデー"}, {name: "焼酎"}, {name: "日本酒"}, {name: "ビール、発泡酒"}, {name: "その他"}])
etcetera_commodity.children.create([{name: "タオル/バス用品"}, {name: "日用品/生活雑貨"}, {name: "洗剤/柔軟剤"}, {name: "旅行用品"}, {name: "防災関連グッズ"}, {name: "その他"}])
etcetera_antique.children.create([{name: "雑貨"}, {name: "工芸品"}, {name: "家具"}, {name: "印刷物"}, {name: "その他"}])
etcetera_stationery.children.create([{name: "筆記具"}, {name: "ノート/メモ帳"}, {name: "テープ/マスキングテープ"}, {name: "カレンダー/スケジュール"}, {name: "アルバム/スクラップ"}, {name: "ファイル/バインダー"}, {name: "はさみ/カッター"}, {name: "カードホルダー/名刺管理"}, {name: "のり/ホッチキス"}, {name: "その他"}])
etcetera_office.children.create([{name: "オフィス用品一般"}, {name: "オフィス家具"}, {name: "店舗用品"}, {name: "OA機器"}, {name: "ラッピング/包装"}, {name: "その他"}])
